...
**Задание 1 (Базовый уровень):** ([рис. @fig-007]).

![График](image/task1.png){#fig-007 width=70%}
...
**Задание 2 (Исследование порога):** [табл. @tbl-1]

| Параметр | Значение |
|----------|---------|
| Экспериментальный порог $\beta$ | 0.16 |
| Теоретический порог ($\gamma$ = 1/14) | 0.0714 |
| Отношение (эксп/теор) | 2.24 |
: Результаты поиска минимального значения $\beta$, при котором пик заболеваемости превышает 5% популяции {#tbl-1}
...
**Задание 3 (Эффект гетерогенности):** ([рис. @fig-008]).

![График](image/task3.png){#fig-008 width=70%}
...
**Задание 4 (Миграция):** [табл. @tbl-2]

| Интенсивность миграции (x) | Время до пика (дни) |
|---------------------------|---------------------|
| 0.0 | 11 |
| 0.1 | 14 |
| 0.2 | 12 |
...
| 0.4 | 12 |
| 0.5 | 11 |
: Влияние интенсивности миграции на время достижения пика заболеваемости {#tbl-2}
...
**Задание 5 (Карантинные меры):** ([рис. @fig-009]).

![График](image/task5.png){#fig-009 width=70%}
...
**Задание 6 (Оптимизация):** [табл. @tbl-3]

| Параметр | Оптимальное значение | Диапазон поиска |
|----------|---------------------|-----------------|
| $\beta$ (коэффициент заразности) | 0.330 | 0.1 – 0.8 |
| detection_time (время выявления, дни) | 4.10 | 3 – 14 |
| death_rate (летальность) | 0.033 | 0.001 – 0.05 |
: Результаты многокритериальной оптимизации параметров модели (минимизация смертности при ограничении пика заболеваемости ≤ 30%) {#tbl-3}
