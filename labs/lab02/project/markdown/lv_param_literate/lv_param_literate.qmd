...
![Влияние параметра $\alpha$](../project/plots/lv_literate/lv_alpha_study.png){#fig-001 width=70%}
...
```
![Влияние параметра $\beta$](../project/plots/lv_literate/lv_beta_study.png){#fig-002 width=70%}
...
plot!(plt_δ[2], title="Динамика хищников", xlabel="Время", 
	ylabel="Численность хищников", grid=true)
```
![Влияние параметра $\delta$](../project/plots/lv_literate/lv_delta_study.png){#fig-003 width=70%}
...
plot!(plt_γ[2], title="Динамика хищников", xlabel="Время", 
	ylabel="Численность хищников", grid=true)
```
![Влияние параметра $\gamma$](../project/plots/lv_literate/lv_gamma_study.png){#fig-004 width=70%}
...
![Фазовые портреты](../project/plots/lv_literate/lv_phase_portraits.png){#fig-005 width=70%}
