...
plt_β
```
![Влияние параметра $\beta$](../project/plots/parameter_study_literate/beta_study.png){#fig-001 width=70%}

**Анализ:** С увеличением $\beta$ растет R0, эпидемия развивается быстрее,
...
plt_c
```
![Влияние параметра $c$](../project/plots/parameter_study_literate/c_study.png){#fig-002 width=70%}
...
plt_γ
```
![Влияние параметра $\gamma$](../project/plots/parameter_study_literate/gamma_study.png){#fig-003 width=70%}

**Анализ:** Увеличение $\gamma$ (более быстрое выздоровление) снижает R0.
...
plt_control
```
![Меры контроля эпидемии](../project/plots/parameter_study_literate/control_measures.png){#fig-004 width=70%}
